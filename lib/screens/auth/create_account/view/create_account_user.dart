...
class CreateUserAccountTypeScreen extends StatefulWidget {
  const CreateUserAccountTypeScreen({Key? key}) : super(key: key);

  @override
  State<CreateUserAccountTypeScreen> createState() =>
      _CreateUserAccountTypeScreenState();
}

class _CreateUserAccountTypeScreenState
    extends State<CreateUserAccountTypeScreen> with TickerProviderStateMixin {
  @override
  Widget build(
                    ...
                    onPressed: () {
                      ...
                      _createAccountBloc.add(
                        CreateAccountRequested(
                          ...
                          accountType: AccountType.buyer.type,
