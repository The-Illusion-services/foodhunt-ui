...
class _UserChangePasswordState extends State<UserChangePassword> {
  ...
  Widget build(BuildContext context) {
    final _resetPasswordBloc = context.read<UserResetPasswordBloc>();
    ...
    return Scaffold(
      ...
      body: BlocConsumer<UserResetPasswordBloc, UserResetPasswordState>(
                    ...
                    children: [
                      SvgPicture.string(
                        ...
                        colorFilter: ColorFilter.mode(
                            Colors.green[700]!, BlendMode.srcIn),
                        width: 20,
                        height: 20,
                      ),
                      ...
                      Expanded(
                        child: Text(
                          "A code has been sent to your email. Please enter it below to reset your password.",
                          style: TextStyle(
